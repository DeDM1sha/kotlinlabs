...
class MainActivity : AppCompatActivity(), Navigator {
    ...
    override fun launchLab1Screen() {
        launchFragment(Lab1Fragment())
    }

    override fun launchLab2Screen() {
        launchFragment(Lab2Fragment())
    }

    override fun launchLab3Screen(){
    ...
    private fun updateUi() {
        ...
        if (fragment is HasCustomTitle) {
            ...
            binding.toolbar.title = getString(R.string.mainTitle)
        }
